...
/**
 * Describes class that provides helper methods to convert TermDate
 */
public interface TermDateTimeModelAssembler extends RepresentationModelAssembler<TermDateTime, TermDateTimeDTO> {
}
