...
/**
 * JwsUtility is an interface describing java class that generates and processes signed JSON web tokens.
 * 
 * @author Fedor Gabrus
 */
public interface JwsUtility {
     ...
     * @throws JwtException throws if token verification fails
     */
    JwsPayload verifySignatureAndGetPayload(String token) throws JwtException;
