...
/**
 * Describes class that provides helper methods to convert {@link StudyPlanQualification} entity into
 * a representation model.
 */
public interface StudyPlanInfoModelAssembler extends RepresentationModelAssembler<StudyPlanQualification, StudyPlanInfo> {
}
