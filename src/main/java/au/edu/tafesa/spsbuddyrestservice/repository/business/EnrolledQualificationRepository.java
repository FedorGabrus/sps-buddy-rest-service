...
/**
 * Describes StudentStudyPlan entity repository.
 */
public interface EnrolledQualificationRepository extends CrudRepository<StudentStudyPlan, StudentStudyPlanPK> {
}
